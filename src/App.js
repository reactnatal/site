      ...
      <div className="App-content-container">
        <aside className="App-content">
          <ul>
            ...
            <li>Lista de Espera: <strong><a href="https://forms.gle/QQhYXVSpY53NG3qE7" target="_blank" rel="noopener noreferrer">https://bit.ly/2pmQLAh</a></strong>. (Vagas limitadas)</li>
          </ul>
